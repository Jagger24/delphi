				...
				<div class="card" style="width: 18rem;">
					<div class="card-body">
						...
						@if (array_key_exists("groups", $sessioned))
                        	...
                        	@endforeach
                        	<a href="group/{{ $sessioned['code'] }}/{{$group['id']}}"> <button class="btn btn-primary" value="Delphi Code Stats"> Statistics </button> </a>
                        @else
                       		<h5 class="card-text"> Activity: Not Active </h5>
